...
For each of the 7 angles, create **3 subtopics**. Each subtopic must pass the "wow, I never thought of that" test — if it's obvious, replace it.

For each subtopic, create **3 formats:**
